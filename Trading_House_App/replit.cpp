    ...
    public:
        ...
        void showHouseAvailable()
        {
                ...
                if((each->houseOwn)->available == "Available")
                {
                    ...
                    for(auto each : Database)
                    {
                        if(tempUsername == each->userName)
                        {
                            ...
                            {
                                cout << cnt << ") " << reviews->userName << ": " << reviews->comment << ". House rating Score = " << reviews->HouseRatingScore_Avg << "\n";
                                cnt++;
                            }
                        }
                    }
            ...
            if(choice == "Y") 
            {
                ...
                cin >> input_index;
                if(input_index == std::to_string(index) && input_index != "0")
                {
                    Database[index]->listOfrequests.push_back(this);
                }
                else
                {
                    cout << "Sorry this is your house you can't occupy yourself!";
                }
    ...
    public:
        ...
        void LoadDatabase()
        {
            ...
            while(getline(data, line))
            {
                ...
                int i = 29;
                #if 1
                while (tokens.size() > 29 && i < sizeOfRequest * 4 + 29)
                {
